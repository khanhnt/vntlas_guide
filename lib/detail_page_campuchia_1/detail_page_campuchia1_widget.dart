...
class DetailPageCampuchia1Widget extends StatefulWidget {
  const DetailPageCampuchia1Widget({Key key}) : super(key: key);
              ...
              children: [
                          ...
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'nu80gjki' /* Quy định gỗ hợp pháp của Angol... */,
                              ),
                              style: TextStyle(
                                color: Colors.black,
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'jsrq84ia' /* Angola chưa tham gia đàm phán ... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyText1
                                      .override(
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'p1k2bvkj' /* Gợi ý xây dựng và thực hiện tr... */,
                        ),
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '98eryq39' /* Trách nhiệm giải trình là gì? */,
                              ),
                              style:
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'g5og2gfz' /* • Trách nhiệm giải trình là vi... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyText1
                                      .override(
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'q5setvgu' /* Phát triển hệ thống trách nhiệ... */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).title1.override(
                                        fontFamily: 'Poppins',
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'iz1nn4lh' /* • Phát triển một hệ thống với ... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyText1
                                    .override(
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '1iyg5dri' /* Thực hiện trách nhiệm giải trì... */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).title1.override(
                                        fontFamily: 'Poppins',
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'uqhglkgq' /* • Đánh giá tính hợp lệ của tài... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyText1
                                    .override(
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'qeffcxny' /* Các tài liệu sau đây được chọn... */,
                      ),
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'aj1yziv7' /* • Giấy phép khai thác rừng hàn... */,
                                  ),
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyText1
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'lu316bqe' /* Giấy phép khai thác rừng hàng ... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyText1
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '0xcdxkqa' /* Đảm bảo quản lý và lập kế hoạc... */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).title1.override(
                                        fontFamily: 'Poppins',
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  '1fevdje0' /* • Kế hoạch quản lý rừng
Đối vớ... */
                                  ,
                                ),
                                style: FlutterFlowTheme.of(context)
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '7twg5jkj' /* Tham vấn cộng đồng địa phương ... */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).title1.override(
                                        fontFamily: 'Poppins',
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'vui613c7' /* • Bản đồ khu vực nhượng quyền
... */
                                  ,
                                ),
                                style: FlutterFlowTheme.of(context)
