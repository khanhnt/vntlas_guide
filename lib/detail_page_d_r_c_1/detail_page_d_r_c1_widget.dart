...
class _DetailPageDRC1WidgetState extends State<DetailPageDRC1Widget> {
              ...
              children: [
                          ...
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'owknk583' /* Quy định gỗ hợp pháp của Angol... */,
                              ),
                              style: TextStyle(
                                color: Colors.black,
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'm7e9bifs' /* Angola chưa tham gia đàm phán ... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyText1
                                      .override(
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '7cbptnx4' /* Gợi ý xây dựng và thực hiện tr... */,
                        ),
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '4wbdwl5o' /* Trách nhiệm giải trình là gì? */,
                              ),
                              style:
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'slxnndfj' /* • Trách nhiệm giải trình là vi... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyText1
                                      .override(
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '20tb5glr' /* Phát triển hệ thống trách nhiệ... */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).title1.override(
                                        fontFamily: 'Poppins',
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  't6txyofr' /* • Phát triển một hệ thống với ... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyText1
                                    .override(
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '2deujm7o' /* Thực hiện trách nhiệm giải trì... */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).title1.override(
                                        fontFamily: 'Poppins',
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'ifzhv9uu' /* • Đánh giá tính hợp lệ của tài... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyText1
                                    .override(
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'vq4xd74y' /* Các tài liệu sau đây được chọn... */,
                      ),
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '5f514bi4' /* • Giấy phép khai thác rừng hàn... */,
                                  ),
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyText1
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  '8gxj2fwq' /* Giấy phép khai thác rừng hàng ... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyText1
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'qm6lah20' /* Đảm bảo quản lý và lập kế hoạc... */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).title1.override(
                                        fontFamily: 'Poppins',
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'iuqodprt' /* • Kế hoạch quản lý rừng
Đối vớ... */
                                  ,
                                ),
                                style: FlutterFlowTheme.of(context)
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'nd7grurn' /* Tham vấn cộng đồng địa phương ... */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).title1.override(
                                        fontFamily: 'Poppins',
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'knfbhp3z' /* • Bản đồ khu vực nhượng quyền
... */
                                  ,
                                ),
                                style: FlutterFlowTheme.of(context)
