                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: AutoSizeText(
                        FFLocalizations.of(context).getText(
                          'bb7yvsi4' /* VẬN TẢI VÀ THƯƠNG MẠI GỖ */,
                        ),
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyText1.override(
                              fontFamily: 'Poppins',
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'sd3ovkr1' /* Thực hiện tuân thủ đầy đủ các ... */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).title1.override(
                                        fontFamily: 'Poppins',
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'cneazelf' /* • Giấy chứng nhận xuất xứ
Cần ... */
                                    ,
                                  ),
                                  textAlign: TextAlign.start,
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'r7fwo0cs' /* Giấy chứng nhận xuất xứ */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyText1
...
Cần đố... */
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'mhm4xmcj' /* Giấy phép xuất khẩu (Documento... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyText1
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                't16pvh8g' /* Đảm bảo tuân thủ Công ước về b... */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).title1.override(
                                        fontFamily: 'Poppins',
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'vo7ihe6d' /* Đảm bảo tuân thủ quy định về đ... */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).title1.override(
                                        fontFamily: 'Poppins',
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'l49xjd3q' /* • Giấy phép môi trường vận hàn... */,
                                  ),
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyText1
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'o4wvto0m' /* Giấy phép môi trường vận hành ... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyText1
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'ycomnchb' /* Đảm bảo rằng các doanh nghiệp ... */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).title1.override(
                                        fontFamily: 'Poppins',
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '841nuxwa' /* • Báo cáo Sở An toàn và Vệ sin... */,
                                  ),
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyText1
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'q1oyl7o4' /* Đảm bảo tuân thủ các quy định ... */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).title1.override(
                                        fontFamily: 'Poppins',
                          ...
                          expanded: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '3fvn6yyh' /* • Thư thông báo an sinh xã hội... */,
                                  ),
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyText1
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: AutoSizeText(
                        FFLocalizations.of(context).getText(
                          'dbfrdqt2' /* CÁC VẤN ĐỀ XUYÊN SUỐT */,
                        ),
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyText1.override(
                              fontFamily: 'Poppins',
                      ...
                      child: ExpandableNotifier(
                        ...
                        child: ExpandablePanel(
                          header: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'oy8j32gt' /* Tuân thủ các quy định về lao đ... */,
                              ),
                              style:
                                  FlutterFlowTheme.of(context).title1.override(
                                        fontFamily: 'Poppins',
